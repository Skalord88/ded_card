...
public class MapperSpellsTableDTO {
  ...
  public static SpellsTableDTO toSpellsTableDTO(SpellsTable spellsTable) {
    return new SpellsTableDTO(spellsTable);
  }

  public static List<SpellsTableDTO> toSpellsTableDTO(
