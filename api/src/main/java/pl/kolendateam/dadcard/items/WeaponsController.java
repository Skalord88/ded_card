...
public class WeaponsController {
  ...
  public WeaponsController(
    WeaponsRepository weaponRepository,
    CharacterRepository characterRepository
  ) {
  ...
  public CharacterDTO buyWeapons(
    @PathVariable short id,
    @RequestBody WeaponsDTO wDTO
  ) {
  ...
  public CharacterDTO sellWeapons(
    @PathVariable short id,
    @RequestBody WeaponsDTO wDTO
  ) {
    Optional<Character> characterOpt = this.characterRepository.findById(id);
    ...
    int indexOfItem = weapon.findItemIndexinArrayById(
      character.getItems(),
      weapon
    );
