...
public class Item implements Serializable {
  ...
  public Item(WondrousItemsDTO item) {
    this.id = item.id;
    this.name = item.name;
    this.cost = item.cost;
  ...
  public int findItemIndexinArrayById(ArrayList<Item> items, Item w) {
